...
[source,console]
----
$ nix run github:maxwell-lt/modestly-modular-modpack-modifier/0.6.1 -- ./pack-manifest.yml
----
...
For more detailed logging information about individual node operations, set the `RUST_LOG` environment variable to `debug` or `trace`:

[source,console]
----
$ RUST_LOG=debug nix run github:maxwell-lt/modestly-modular-modpack-modifier/0.6.1 -- ./pack-manifest.yml
----

This will show detailed information about mod filtering, resolution progress, and other node operations.
